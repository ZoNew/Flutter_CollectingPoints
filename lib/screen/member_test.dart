...
class MembersTestScreen extends StatefulWidget {
  @override
  _MembersTestScreenState createState() => _MembersTestScreenState();
}

class _MembersTestScreenState extends State<MembersTestScreen> {
  ...
  Future <List<Organization>> getOrganization() async {
    var url = Uri.parse(
        "http://192.168.1.2:3000/organizations");
        ...
        if(snapshot.connectionState == ConnectionState.done){
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              MemberId ojData = result[0].memberId[index];
  ...
  Card buildCard(int index, BuildContext context, MemberId member) {
    return Card(
      elevation: 5,
